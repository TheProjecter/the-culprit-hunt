...
function init() {
    ...
    vctx.drawImage(trap,0,0,587,497,0,0,640,480);
	show();
}
var ctr = 0;
...
function applying(){
	...
	nx = 587*ctr;
	vctx.drawImage(trap,nx,0,587,497,0,0,640,480);
}
...
<img class="img" id="trap" alt="" src="images/trapped.png">
</div>

<div id="right">
<h2>Chapter 4: The Downfall of Jackhalgar</h2>
<h3>Scene 3: Trapped!</h3>
<div id="caption"><p>
The back entrance didn't really deliver John to<br>
Jackhalgar, but instead, he was captured and trapped<br>
by Dewey. He was reversed by the boggling and unexpected<br>
plan by Dewey. 
</p></div>
<form method="post" action="Dispatch" id="left">
<input type="hidden" name="user" value="<%=user %>">
<input type="hidden" name="page" value="TheCulpritHunt_Chapter4AltScene2.jsp">
<input type=submit id="button" name = Chap4A2 value = "Return to Alternate Scene 2">
</form>

<form method="post" action="Dispatch" id="right">
<input type="hidden" name="user" value="<%=user %>">
<input type="hidden" name="page" value="TheCulpritHunt_Chapter4AltScene4.jsp">
<input type=submit id="button" name = Chap4A4 value="Go to Alternate Scene 4">
</form>
<br><br><br>
